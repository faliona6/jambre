...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
ms=e.SecurityContext||(e.SecurityContext={}))[ms.NONE=0]="NONE",ms[ms.HTML=1]="HTML",ms[ms.STYLE=2]="STYLE",ms[ms.SCRIPT=3]="SCRIPT",ms[ms.URL=4]="URL",ms[ms.RESOURCE_URL=5]="RESOURCE_URL";var bs,Cs=function Cs(){},xs=new(bs=function bs(e){this.full=e,this.major=e.split(".")[0],this.minor=e.split(".")[1],this.patch=e.split(".").slice(2).join(".")})("7.2.3"),Is=function(e){function t(t){var n=e.call(this)||this;return n.ngModule=t,n}return o(t,e),t.prototype.resolveComponentFactory=function(e){var t=ge(e);return new Ps(t,this.ngModule)},t}(es);
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
